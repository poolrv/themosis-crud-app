    ...
    <div class="row justify-content-center">
        <div class="col-12 col-lg-8">
            <div class="card shadow border-0 rounded-3 overflow-hidden">
                <!-- Card Header -->
                <div class="card-header bg-gradient-warning text-white py-4 px-4 border-0">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h5 class="mb-1 fw-bold">Actualizar Información Personal</h5>
                            <small class="opacity-75">Modifica los campos que necesites cambiar</small>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body border-bottom bg-light p-4">
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            <div class="d-flex align-items-center">
                                <div class="avatar-lg bg-warning bg-gradient rounded-circle d-flex align-items-center justify-content-center me-3">
                                    <i class="fas fa-user text-white fs-4"></i>
                                </div>
                                <div>
                                    <h6 class="mb-1 fw-bold text-dark">Información Actual</h6>
                                    <p class="mb-0 text-muted">{{ $persona->nombre }} {{ $persona->apellido }} - {{ $persona->rut_formateado }}</p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card-body p-5">
                    <form method="POST" action="{{ route('personas.update', $persona->id) }}" class="persona-form" novalidate>
                        @csrf
                        @method('PUT')
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group input-group-lg">
                                        ...
                                        <input 
                                            ...
                                            type="text" 
                                            id="rut" 
                                            value="{{ old('rut', $persona->rut_formateado) }}" 
                            ...
                            <div class="col-12">
                                <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                                    <div class="d-flex align-items-center text-muted">
                                        ...
                                        <small>Los cambios se guardarán de forma segura</small>
                                    </div>
                                    ...
                                    <div class="d-flex gap-3">
                                        ...
                                        <button type="submit" class="btn btn-warning btn-lg px-5 py-2 shadow-sm text-white">
        ...
        <div class="col-md-4">
            <div class="card border-0 bg-light h-100">
                <div class="card-body text-center p-4">
                    <div class="avatar-lg bg-warning bg-gradient rounded-circle d-flex align-items-center justify-content-center mx-auto mb-3">
                        <i class="fas fa-edit text-white fs-4"></i>
                    </div>
                    <h6 class="fw-bold mb-2">Edición Segura</h6>
                    <small class="text-muted">Todos los cambios son validados antes de guardar</small>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card border-0 bg-light h-100">
                <div class="card-body text-center p-4">
                    ...
                    <h6 class="fw-bold mb-2">Historial Preservado</h6>
                    <small class="text-muted">Se mantiene un registro de todos los cambios</small>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card border-0 bg-light h-100">
                <div class="card-body text-center p-4">
                    ...
                    <h6 class="fw-bold mb-2">Actualización Instantánea</h6>
                    <small class="text-muted">Los cambios se reflejan inmediatamente</small>
                </div>
            </div>
        </div>
    </div>
...
/* Pulse animation for changed fields */
@keyframes pulse {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Validación de nombres (solo letras y espacios) y detección de cambios
    const nombreInput = document.getElementById('nombre');
    const apellidoInput = document.getElementById('apellido');
    
    [nombreInput, apellidoInput].forEach((input, index) => {
        const fieldName = index === 0 ? 'nombre' : 'apellido';
    ...
    // Validación de fecha y detección de cambios
    ...
    fechaInput.addEventListener('change', function() {
        ...
        // Detectar cambios
        if (this.value !== originalValues.fecha_nacimiento) {
            this.classList.add('changed');
        } else {
            this.classList.remove('changed');
        }
    ...
    // Detectar si hay cambios para mostrar confirmación al salir
    let hasChanges = false;
    inputs.forEach(input => {
        input.addEventListener('input', function() {
            hasChanges = document.querySelector('.changed') !== null;
        });
    });
