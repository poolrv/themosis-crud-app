...
// Agregar menú de administración para personas
        add_action('admin_menu', 'agregar_menu_personas');

        function agregar_menu_personas() {
            add_menu_page(
                'Gestión de Personas',      // Título de la página
                'Personas',                 // Texto del menú
                'manage_options',          // Capacidad requerida
                'personas',                // Slug del menú
                'mostrar_pagina_personas', // Función callback
